...
class Model(nn.Module):
	...
	def __init__(self, configs):
		...
		self.backbone = Theta(season_mode=SeasonalityMode.NONE)
		self.fit(configs)
	...
	def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
		...
		#? Theta cannot calculate input data, thus just input pred len
		dec_out = self.backbone.predict(self.pred_len).values()

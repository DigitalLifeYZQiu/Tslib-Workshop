...
def linear_beta_schedule(timesteps):
    """
    Creates a linear schedule of beta values for diffusion models.

    Args:
        timesteps (int): Total number of timesteps in the diffusion process.

    Returns:
        torch.Tensor: Linearly spaced beta values from beta_start to beta_end.
    """
...
def cosine_beta_schedule(timesteps, s=0.008):
    ...
    Args:
        ...
        s (float): Small offset to prevent singularities (default is 0.008).

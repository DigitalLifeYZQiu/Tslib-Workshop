...
import numpy as np
from layers.Embed import PatchEmbedding, TimeBertPatchEmbedding
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if configs.ckpt_path != '':
            ...
            d_ff = d_model * 4 if d_model == 768 or (
                        d_model == 1024 and layers == 24) or d_model == 256 or d_model == 192 else d_model * 2
        ...
        if (
                patch_encoder_checkpoint == '../ltsm/checkpoints/uea_ucr_bert_d1024_l8_p16_n512_weight_p50_wo_revin_full.ckpt'

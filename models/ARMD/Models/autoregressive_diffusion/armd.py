...
from models.ARMD.Models.autoregressive_diffusion.linear import Linear
from models.ARMD.Models.autoregressive_diffusion.model_utils import default, identity, extract
...
class ARMD(nn.Module):
    def __init__(
        ...
        sampling_timesteps = Configs.sampling_timesteps
        loss_type = Configs.loss_type
        beta_schedule = Configs.beta_schedule

        self.eta = eta
        self.seq_length = Configs.seq_len
        self.feature_size = Configs.feature_size

        self.model = Linear(n_feat=self.feature_size, n_channel=self.seq_length, **kwargs)

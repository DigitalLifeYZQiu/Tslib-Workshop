...
ckpt_path="/data/zhanghaoran/projects/ltsm/experiments/bert/bert/lotsa_uea_bert_d192_l3_p4_n512_weight_p25_wo_revin_long/21012025_155744/ckpt/bert/bert/lotsa_uea_bert_d192_l3_p4_n512_weight_p25_wo_revin_long-epoch=02.ckpt"
for seq_len in 40
do
...
# > scriptsTimeBert/sota/TimeBert_SWAT_small.log && bash scriptsTimeBert/sota/TimeBert_SWAT_small.sh 2>&1 | tee -a scriptsTimeBert/sota/TimeBert_SWAT_small.log
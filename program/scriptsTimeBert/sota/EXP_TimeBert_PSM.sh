...
mkdir -p logs/TimeBert_PSM  # 创建日志目录
        ...
        for epoch in "${epoch_list[@]}"; do
          ...
          (
            ...
            python -u run.py \
              ...
              --date_record \
              --lradj "$lradj" \
              > "logs/TimeBert_PSM/TimeBert_PSM_seq${seq_len}_mask${mask_rate}_lr${lr}-${lradj}_epoch${epoch}.log" 2>&1
          ) &

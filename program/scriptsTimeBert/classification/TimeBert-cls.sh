...
# > scriptsTimeBert/classification/TimeBert-cls.log && bash scriptsTimeBert/classification/TimeBert-cls.sh 2>&1 | tee -a scriptsTimeBert/classification/TimeBert-cls.log
# 定义日志文件
LOG_FILE="scriptsTimeBert/zs/TimeBert.log"

# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scriptsTimeBert/zs/TimeBert_MSL.sh"
    "scriptsTimeBert/zs/TimeBert_PSM.sh"
    "scriptsTimeBert/zs/TimeBert_SMAP.sh"
    "scriptsTimeBert/zs/TimeBert_SMD.sh"
    "scriptsTimeBert/zs/TimeBert_SWAT.sh"
)

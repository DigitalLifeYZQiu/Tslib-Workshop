...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scriptsARIMApp/torchARIMA/torchARIMA_ECL.sh"
    "scriptsARIMApp/torchARIMA/torchARIMA_ETTh1.sh"
    "scriptsARIMApp/torchARIMA/torchARIMA_ETTh2.sh"
    "scriptsARIMApp/torchARIMA/torchARIMA_ETTm1.sh"
    "scriptsARIMApp/torchARIMA/torchARIMA_ETTm2.sh"
    "scriptsARIMApp/torchARIMA/torchARIMA_Exchange.sh"
    "scriptsARIMApp/torchARIMA/torchARIMA_Traffic.sh"
    "scriptsARIMApp/torchARIMA/torchARIMA_Weather.sh"
)

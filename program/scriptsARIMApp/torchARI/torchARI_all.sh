...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scriptsARIMApp/torchARI/torchARI_ECL.sh"
    "scriptsARIMApp/torchARI/torchARI_ETTh1.sh"
    "scriptsARIMApp/torchARI/torchARI_ETTh2.sh"
    "scriptsARIMApp/torchARI/torchARI_ETTm1.sh"
    "scriptsARIMApp/torchARI/torchARI_ETTm2.sh"
    "scriptsARIMApp/torchARI/torchARI_Exchange.sh"
    "scriptsARIMApp/torchARI/torchARI_Traffic.sh"
    "scriptsARIMApp/torchARI/torchARI_Weather.sh"
)

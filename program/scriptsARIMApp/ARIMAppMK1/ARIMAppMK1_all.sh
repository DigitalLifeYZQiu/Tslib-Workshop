...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scriptsARIMApp/ARIMAppMK1/ARIMAppMK1_ECL.sh"
    "scriptsARIMApp/ARIMAppMK1/ARIMAppMK1_ETTh1.sh"
    "scriptsARIMApp/ARIMAppMK1/ARIMAppMK1_ETTh2.sh"
    "scriptsARIMApp/ARIMAppMK1/ARIMAppMK1_ETTm1.sh"
    "scriptsARIMApp/ARIMAppMK1/ARIMAppMK1_ETTm2.sh"
    "scriptsARIMApp/ARIMAppMK1/ARIMAppMK1_Exchange.sh"
    "scriptsARIMApp/ARIMAppMK1/ARIMAppMK1_Traffic.sh"
    "scriptsARIMApp/ARIMAppMK1/ARIMAppMK1_Weather.sh"
)

...
# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scriptsARIMApp/ARIMAlinMK2/ARIMAlinMK2_ECL.sh"
    "scriptsARIMApp/ARIMAlinMK2/ARIMAlinMK2_ETTh1.sh"
    "scriptsARIMApp/ARIMAlinMK2/ARIMAlinMK2_ETTh2.sh"
    "scriptsARIMApp/ARIMAlinMK2/ARIMAlinMK2_ETTm1.sh"
    "scriptsARIMApp/ARIMAlinMK2/ARIMAlinMK2_ETTm2.sh"
    "scriptsARIMApp/ARIMAlinMK2/ARIMAlinMK2_Exchange.sh"
    "scriptsARIMApp/ARIMAlinMK2/ARIMAlinMK2_Traffic.sh"
    "scriptsARIMApp/ARIMAlinMK2/ARIMAlinMK2_Weather.sh"
)

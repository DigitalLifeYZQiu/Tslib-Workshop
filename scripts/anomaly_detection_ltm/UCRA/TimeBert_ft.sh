...
for mask_rate in 0.3 0.4 0.5 0.6 0.7 0.8 0.9
do
  log_dir=logs/UCRA_ltm/TimeBERT_ft_mask${mask_rate}/logger
  mkdir -p ${log_dir}  # 创建日志目录
  csv_dir=logs/UCRA_ltm/TimeBERT_ft_mask${mask_rate}/results

...
ckpt_path="/data/zhanghaoran/projects/ltsm/experiments/bert/bert/lotsa_uea_bert_d768_l12_p4_n512_weight_p50_wo_revin_long/28032025_161618/ckpt/bert/bert/lotsa_uea_bert_d768_l12_p4_n512_weight_p50_wo_revin_long-epoch=02.ckpt"

log_dir=logs/UCRA_ltm/TimeBERT_zs_longBaseP4/logger
mkdir -p ${log_dir}  # 创建日志目录
csv_dir=logs/UCRA_ltm/TimeBERT_zs_longBaseP4/results

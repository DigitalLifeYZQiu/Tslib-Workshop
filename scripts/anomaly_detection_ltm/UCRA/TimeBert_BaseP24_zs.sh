...
ckpt_path="/data/zhanghaoran/projects/ltsm/experiments/bert/bert/lotsa_uea_bert_d768_l12_p24_n512_weight_p25_wo_revin_long/08012025_010805/ckpt/bert/bert/lotsa_uea_bert_d768_l12_p24_n512_weight_p25_wo_revin_long-epoch=02.ckpt"

log_dir=logs/UCRA_ltm/TimeBERT_zs_BaseP24/logger
mkdir -p ${log_dir}  # 创建日志目录
csv_dir=logs/UCRA_ltm/TimeBERT_zs_BaseP24/results

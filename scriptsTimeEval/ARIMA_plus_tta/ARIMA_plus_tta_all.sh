...
# 定义日志文件
LOG_FILE="scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta.log"

# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta_ETTh1.sh"
    "scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta_ETTh2.sh"
    "scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta_ETTm1.sh"
    "scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta_ETTm2.sh"
    "scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta_ECL.sh"
    "scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta_Traffic.sh"
    "scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta_Weather.sh"
    "scriptsTimeEval/ARIMA_plus_tta/ARIMA_plus_tta_Exchange.sh"
)

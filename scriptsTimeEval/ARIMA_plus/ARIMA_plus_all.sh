...
# 定义日志文件
LOG_FILE="scriptsTimeEval/ARIMA_plus/ARIMA_plus.log"

# 定义要执行的脚本列表（按顺序执行）
SCRIPTS=(
    "scriptsTimeEval/ARIMA_plus/ARIMA_plus_ETTh1.sh"
    "scriptsTimeEval/ARIMA_plus/ARIMA_plus_ETTh2.sh"
    "scriptsTimeEval/ARIMA_plus/ARIMA_plus_ETTm1.sh"
    "scriptsTimeEval/ARIMA_plus/ARIMA_plus_ETTm2.sh"
    "scriptsTimeEval/ARIMA_plus/ARIMA_plus_ECL.sh"
    "scriptsTimeEval/ARIMA_plus/ARIMA_plus_Traffic.sh"
    "scriptsTimeEval/ARIMA_plus/ARIMA_plus_Weather.sh"
    "scriptsTimeEval/ARIMA_plus/ARIMA_plus_Exchange.sh"
)
